...
export default class ChirpBox extends Component {
  ...
  postChirp = (event) => {
    ...
    //if u wanna reference db u need to reference it
    // ref tells u what key to ref 
    let chirpRef = firebase.database().ref('chirps');

    //assign data for that ref in the db
    chirpRef.push(newChirp);
